...
const TextType = ({
  ...
  const resolvedTexts = texts || text || '';
  const textArray = useMemo(() => (Array.isArray(resolvedTexts) ? resolvedTexts : [resolvedTexts]), [resolvedTexts]);
      ...
      if (isDeleting) {
        ...
        if (currentCharIndex < processedText.length) {
          timeout = setTimeout(
            ...
            (variableSpeedEnabled || variableSpeed) ? getRandomSpeed() : typingSpeed
          );
